...
$MESS ['T_IBLOCK_DESC_IBORD1'] = "Поле для первой сортировки событий";
$MESS ['T_IBLOCK_DESC_IBBY1'] = "Направление для первой сортировки событий";
$MESS ['T_IBLOCK_DESC_IBORD2'] = "Поле для второй сортировки событий";
$MESS ['T_IBLOCK_DESC_IBBY2'] = "Направление для второй сортировки событий";
$MESS ['T_IBLOCK_DESC_LIST_ID'] = "Код информационного блока";
$MESS ['T_IBLOCK_DESC_LIST_TYPE'] = "Тип информационного блока";
$MESS ['T_IBLOCK_DESC_LIST_CONT'] = "Количество событий на странице";
$MESS ['T_IBLOCK_DESC_LAST_DAYS'] = "Показывать события с началом активности не позже чем через (дней)";
$MESS ['T_IBLOCK_DESC_ACTIVE_DATE_FORMAT'] = "Формат показа даты";
$MESS ['T_IBLOCK_DESC_SHOW_FINISHED'] = 'Показывать прошедшие собыития';
$MESS ['CP_BNL_FIELD_CODE'] = "Поля";
$MESS ['CP_BNL_CACHE_GROUPS'] = "Учитывать права доступа";
$MESS ['PARAMETER_THUMBNAIL_WIDTH'] = "Ширина миниаютюры";
$MESS ['PARAMETER_THUMBNAIL_HEIGHT'] = "Высота миниаютюры";
